...
#define KEYS_GPIO_REG_MODEL             GPIOI->IDR
#define KEYS_GPIO_PIN_MODEL             GPIO_Pin_4  // PI.04
...
#define ADC_GPIOA_PINS                  (STICKS_PWM_ENABLED() ? 0 : (GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5))
